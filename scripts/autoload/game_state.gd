...
# ---- 场景路径（与 Main 状态机一致）----
const SCENE_TOWN := "res://scenes/town/town.tscn"
const SCENE_DUNGEON := "res://scenes/dungeon/dungeon_explore.tscn"
const SCENE_BATTLE := "res://scenes/battle/battle_placeholder.tscn"
...
func _ready() -> void:
	_dungeon_config = DataLoader.get_config("dungeons.json")

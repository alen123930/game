...
func _ready() -> void:
	...
	if _dungeon.is_empty():
		_dungeon = DungeonGenerator.generate(DataLoader.get_config("dungeons.json"), GameState.quest_length)
...
func _on_scout_pressed() -> void:
	...
	if randf() < scout_chance:
		room["revealed"] = true
		room["scouted"] = true
		var type_cfg: Dictionary = DataLoader.get_config("dungeons.json").get("dungeon_types", {})
...
func _start_encounter(is_boss: bool) -> void:
	...
	GameState.request_scene(GameState.SCENE_BATTLE)
...
func _end_run(victory: bool) -> void:
	...
	GameState.request_scene("res://scenes/result/result.tscn")
